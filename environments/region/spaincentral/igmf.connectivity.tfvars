# igmf × spaincentral × connectivity — values only (stack code: environments/igmf/connectivity)
# Pipeline: -var-file=environments/region/spaincentral/igmf.connectivity.tfvars
