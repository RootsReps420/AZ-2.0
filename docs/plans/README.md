...
| 04 | [Gap analysis — legacy vs TF](04-gap-analysis-legacy-vs-tf.md) | Under review | Double-check of TF-worthy legacy deployables vs current stacks; P0–P2 gaps and remediation waves A–D (not executed yet). |
