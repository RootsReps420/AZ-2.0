# environments/igmf/avd — MSH host pools + per-BU scaling plans (+ decom siblings)
# IGMF sandbox (ignitemyfire.co.uk). Session hosts stay PowerShell.
# Registration token outputs for Get-PlacementAVD.
