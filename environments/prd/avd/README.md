...
Azure Virtual Desktop objects for **prd**: multisession, personal, and privileged host pools.
...
Catalog from `PERS-General` + `PERS-Packaging`: Personal / Direct / Persistent / max 9999 / start VM on connect. Workspace friendly name `LIVE-DESKTOPS`. Toggle with `enable_pers_host_pools`.
